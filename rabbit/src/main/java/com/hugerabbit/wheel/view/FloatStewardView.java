package com.hugerabbit.wheel.view;
...
public class FloatStewardView extends RelativeLayout implements View.OnClickListener{
    ...
    private ImageView steward_round_iv;
    //    private ImageView steward_arrow_iv;
    private String    headerurl, userName;
...
//
//        if (isVisitor) {
//            int surplusWidth = DimensionPixelUtil.getScreenWidth(floatContext) - DimensionPixelUtil.dip2px(floatContext, 200);
//            //游客
...
//            valueAnimator.start();
//        } else {
//            int surplusWidth = DimensionPixelUtil.getScreenWidth(floatContext) - DimensionPixelUtil.dip2px(floatContext, 160);
//            //用户
//            ValueAnimator valueAnimator = ValueAnimator.ofInt(0, 100);
//            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
//                @Override
